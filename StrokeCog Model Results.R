...
setcolorder(Tab_40_89,c("AgeGroup","stroke_prevm_2016","stroke_prevlr_2016","stroke_prevupr_2016",
                        "stroke_prevm_2035","stroke_prevlr_2035","stroke_prevupr_2035",
                                            ...
                                            "QALYm_2016","QALYlr_2016","QALYupr_2016",
                                            "QALYm_2035","QALYlr_2035","QALYupr_2035",
...
pc_inc[,pc_inc_QALY:=(((QALY_2035-QALY_2016)/QALY_2016)*100)]
...
pc_inc_est<-pc_inc[,list(
                        pc_inc_stroke_prevlr=quantile(pc_inc_strokeprev, 0.05),
                                  ...
                                  pc_inc_QALYlr=quantile(pc_inc_QALY, 0.05),
                                  ...
                                  pc_inc_QALYupr=quantile(pc_inc_QALY, 0.95),
                                  ...
                                  pc_inc_QALYm=median(pc_inc_QALY)),by=list()
]
...
setcolorder(pc_inc_est,c("AgeGroup","pc_inc_stroke_prevm","pc_inc_stroke_prevlr","pc_inc_stroke_prevupr",
                         ...
                         "pc_inc_QALYm","pc_inc_QALYlr","pc_inc_QALYupr"
))
...
####Epi Paper - Table 2 - By Age Group####
...
pc_inc_age[,pc_inc_QALY:=(((QALY_2035-QALY_2016)/QALY_2016)*100)]
#Recurrence is estimated from 2017
...
pc_inc_est_age<-pc_inc_age[,list(
  ...
  pc_inc_CIFLYm=median(pc_inc_CIFLY),
  pc_inc_Recm=median(pc_inc_Rec),
  pc_inc_QALYm=median(pc_inc_QALY))
  ,by=list(AgeGroup2)
]
...
##Sex combined graphs for presentations

Fig2_pres<-ggplot(x_est,
                 aes(x=Year, y=Demm))+
  geom_point()+geom_line()+
  scale_x_continuous(breaks = c(2016,2020,2025,2030,2035))+
  expand_limits(y = 0)+
...
Fig2_pres + geom_ribbon(aes(ymin=x_est$Demlr, ymax=x_est$Demupr), linetype=2, alpha=0.1,colour="#009E73",fill="#009E73") +
  geom_ribbon(aes(ymin=x_est$CINDlr, ymax=x_est$CINDupr), linetype=2, alpha=0.1,colour="#CC79A7",fill="#CC79A7") +
  geom_line(aes(x=x_est$Year, y=x_est$CINDm)) +
  geom_point(aes(x=x_est$Year, y=x_est$CINDm))+ 
  geom_line(aes(x=x_est$Year, y=x_est$stroke_prevm)) +
  geom_point(aes(x=x_est$Year, y=x_est$stroke_prevm))+ 
  geom_ribbon(aes(ymin=x_est$stroke_prevlr, ymax=x_est$stroke_prevupr), linetype=2, alpha=0.1,colour="#56B4E9",fill="#56B4E9") +
  ylab("Prevalent Stroke, Post-stroke Dementia & CIND") 

ggsave(filename = "Fig 2 Pres.png")

Fig3_pres<-ggplot(x_est,
                  aes(x=Year, y=newDemm))+
  geom_point()+geom_line()+
  scale_x_continuous(breaks = c(2016,2020,2025,2030,2035))+
  expand_limits(y = 0)+
  theme_bw()

Fig3_pres + geom_ribbon(aes(ymin=x_est$newDemlr, ymax=x_est$newDemupr), linetype=2, alpha=0.1,colour="#009E73",fill="#009E73") +
  geom_ribbon(aes(ymin=x_est$newCINDlr, ymax=x_est$newCINDupr), linetype=2, alpha=0.1,colour="#CC79A7",fill="#CC79A7") +
  geom_line(aes(x=x_est$Year, y=x_est$newCINDm)) +
  geom_point(aes(x=x_est$Year, y=x_est$newCINDm))+ 
  geom_line(aes(x=x_est$Year, y=x_est$stroke_incm)) +
  geom_point(aes(x=x_est$Year, y=x_est$stroke_incm))+ 
  geom_ribbon(aes(ymin=x_est$stroke_inclr, ymax=x_est$stroke_incupr), linetype=2, alpha=0.1,colour="#56B4E9",fill="#56B4E9") +
  ylab("Incident Stroke, Post-stroke Dementia & CIND") 

ggsave(filename = "Fig 3 Pres.png")
