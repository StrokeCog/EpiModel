...
#This code generates the model for women
...
x_W<-res[Age<90,list(pop=sum(Pop),stroke_deaths=sum(stroke_deaths),
...
x_W2<-res[Age<90,list(pop=sum(Pop),stroke_deaths=sum(stroke_deaths),
                     nstroke_deaths=sum(nstroke_deaths),
                     stroke_inc=sum(stroke_inc),
                     NCI=sum(NCI),
                     CIND=sum(CIND),
...
x_allages_W<-res[Age<90,list(pop=sum(Pop),
...
x_W_est<-x_allages_W[Year>=2016,list(pop=max(pop),
...
setcolorder(x_W_est,c("Year","pop","stroke_deathslr","stroke_deathsm","stroke_deathsupr",
...
write.xlsx(x_W_est,"W_est_BC.xlsx", rows=1:30,cols=1:46)


#results by age

x_W_est_age<-x_W[Year>=2016,list(pop=max(pop),
                                     stroke_deathslr=quantile(stroke_deaths, 0.05),
                                     nstroke_deathslr=quantile(nstroke_deaths, 0.05),
                                     stroke_inclr=quantile(stroke_inc, 0.05),
                                     NCIlr=quantile(NCI, 0.05),
...
#set column order
setcolorder(x_W_est_age,c("Year","pop","stroke_deathslr","stroke_deathsm","stroke_deathsupr",
                      "nstroke_deathslr", "nstroke_deathsm", "nstroke_deathsupr",
                      "stroke_inclr","stroke_incm","stroke_incupr",
                      "NCIlr", "NCIm", "NCIupr",
                      "CINDlr","CINDm","CINDupr",
...
#Output to Excel
write.xlsx(x_W_est_age,"W_est_age_BC.xlsx", rows=1:100,cols=1:46)


#results by age group 2

x_W_est_age2<-x_W2[Year>=2016,list(pop=max(pop),
                                 stroke_deathslr=quantile(stroke_deaths, 0.05),
                                 nstroke_deathslr=quantile(nstroke_deaths, 0.05),
                                 stroke_inclr=quantile(stroke_inc, 0.05),
                                 NCIlr=quantile(NCI, 0.05),
...
#set column order
setcolorder(x_W_est_age2,c("Year","pop","stroke_deathslr","stroke_deathsm","stroke_deathsupr",
                          "nstroke_deathslr", "nstroke_deathsm", "nstroke_deathsupr",
                          "stroke_inclr","stroke_incm","stroke_incupr",
                          "NCIlr", "NCIm", "NCIupr",
                          "CINDlr","CINDm","CINDupr",
...
#Output to Excel
write.xlsx(x_W_est_age2,"W_est_age2_BC.xlsx", rows=1:100,cols=1:46)
...
sd_W_est_age<-sd_age[,list(stroke_deathsm=median(stroke_deaths),
                           stroke_deathslr=quantile(stroke_deaths, 0.05),
                           stroke_deathsupr=quantile(stroke_deaths, 0.95)
),
...
#results by age group 3
sd_W_est<-sd[,list(stroke_deathsm=median(stroke_deaths),
                   stroke_deathslr=quantile(stroke_deaths, 0.05),
                   stroke_deathsupr=quantile(stroke_deaths, 0.95)
),
by=list(Year)]
