...
#Section 18 includes code to validate the model, based on comparison with independent data sources





##install relevant R packages - do not run if packages already installed and up to date
